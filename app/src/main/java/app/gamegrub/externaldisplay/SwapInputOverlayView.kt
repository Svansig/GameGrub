package app.gamegrub.externaldisplay
    ...
    fun setMode(mode: ExternalDisplayInputController.Mode) {
        ...
        when (mode) {
            ExternalDisplayInputController.Mode.KEYBOARD -> {
                hintIcon.visibility = VISIBLE
                keyboardToggleButton.visibility = GONE
                keyboardView.visibility = VISIBLE
                updateToggleButtonPosition()
            }

            ExternalDisplayInputController.Mode.HYBRID -> {
                hintIcon.visibility = GONE
                keyboardToggleButton.visibility = VISIBLE
