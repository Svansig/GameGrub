...
class SteamService : Service(), IChallengeUrlChanged {
    ...
    companion object {
        ...
        var cachedAchievements: List<app.gamegrub.statsgen.Achievement>? = null
            private set
