...
import app.gamegrub.data.GOGCloudSavesLocation
import app.gamegrub.data.GOGCloudSavesLocationTemplate
    ...
    suspend fun getSaveDirectoryPath(
        ...
        try {
            ...
            for ((index, locationTemplate) in locations.withIndex()) {
                Timber.tag("GOG")
                    .d("[Cloud Saves] Resolving location ${index + 1}/${locations.size}: '${locationTemplate.name}' = '${locationTemplate.location}'")
