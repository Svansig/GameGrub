            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                Row(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(app.gamegrub.R.string.bind_button, buttonName),
                            style = MaterialTheme.typography.titleSmall,
                            fontWeight = FontWeight.Bold,
                        )
                        if (currentBinding != null) {
                            Text(
                                text = stringResource(app.gamegrub.R.string.current_binding, currentBinding.toString()),
                    ...
                    Column(
                        ...
                        if (!isSearchExpanded) {
                            ...
                            OutlinedButton(
                                ...
                                Text(
                                    text = stringResource(app.gamegrub.R.string.search_placeholder),
                            ...
                            OutlinedTextField(
                                ...
                                placeholder = {
                                    Text(
                                        stringResource(app.gamegrub.R.string.search_placeholder),
                                        style = MaterialTheme.typography.bodySmall,
                                    )
                                },
                                leadingIcon = {
                                ...
                                trailingIcon = {
                                    IconButton(
                                        ...
                                        Icon(
                                            Icons.Default.Close,
                                            contentDescription = stringResource(app.gamegrub.R.string.clear_search),
                                            modifier = Modifier.size(18.dp),
                                        )
                                    }
                                },
                        ...
                        Column(
                            ...
                            Text(
                                text = stringResource(app.gamegrub.R.string.category),
                            ...
                            CategoryButton(
                                categoryIndex = 0,
                                label = stringResource(app.gamegrub.R.string.keyboard),
                            ...
                            CategoryButton(
                                categoryIndex = 1,
                                label = stringResource(app.gamegrub.R.string.mouse),
                            ...
                            CategoryButton(
                                categoryIndex = 2,
                                label = stringResource(app.gamegrub.R.string.gamepad),
                            ...
                            CategoryButton(
                                categoryIndex = 3,
                                label = stringResource(app.gamegrub.R.string.extra),
                            ...
                            if (currentBinding != null) {
                                ...
                                Surface(
                                    ...
                                    Row(
                                        ...
                                        Text(
                                            text = stringResource(app.gamegrub.R.string.clear_binding),
                                            style = MaterialTheme.typography.bodyMedium,
                                            fontWeight = FontWeight.Bold,
                    ...
                    Column(
                        ...
                        if (filteredBindings.isEmpty()) {
                            Box(
                                ...
                                Text(
                                    text = stringResource(app.gamegrub.R.string.no_bindings_found),
                                    style = MaterialTheme.typography.bodyMedium,
