                    ...
                    CenterAlignedTopAppBar(
                        title = {
                            Column(
                                ...
                                Text(
                                    text = stringResource(
                                        R.string.element_position_size,
                                        element.x.toInt(),
                                        element.y.toInt(),
                                        currentScale,
                                    ),
                            ...
                            IconButton(
                                onClick = {
                                    ...
                                    if (types[currentTypeIndex] == ControlElement.Type.RANGE_BUTTON) {
                                        element.range = rangeTypes[currentRangeTypeIndex]
                                    ...
                                    if (types[currentTypeIndex] == ControlElement.Type.BUTTON) {
                                        element.isToggleSwitch = currentToggleSwitch
                                    }
                        ...
                        if (availableShapes.size > 1) {
                            ...
                            SettingsMenuLink(
                                ...
                                subtitle = {
                                    Text(
                                        stringResource(
                                            R.string.shape_restricted,
                                            element.type.name,
                                            availableShapes[0].name.replace("_", " "),
                                        ),
                                    )
                                },
                                enabled = false,
                        ...
                        SettingsGroup(title = { Text(stringResource(R.string.range_button_settings)) }) {
                            ...
                            SettingsListDropdown(
                                ...
                                onItemSelected = { index ->
                                    ...
                                    element.range = rangeTypes[index]
