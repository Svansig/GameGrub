...
import app.gamegrub.data.TouchGestureConfig.Companion.ACTION_LEFT_CLICK
import app.gamegrub.data.TouchGestureConfig.Companion.ACTION_MIDDLE_CLICK
import app.gamegrub.data.TouchGestureConfig.Companion.ACTION_RIGHT_CLICK
import app.gamegrub.data.TouchGestureConfig.Companion.COMMON_MOUSE_ACTIONS
import app.gamegrub.data.TouchGestureConfig.Companion.PAN_ACTIONS
import app.gamegrub.data.TouchGestureConfig.Companion.PAN_ARROW_KEYS
import app.gamegrub.data.TouchGestureConfig.Companion.PAN_MIDDLE_MOUSE
import app.gamegrub.data.TouchGestureConfig.Companion.PAN_WASD
import app.gamegrub.data.TouchGestureConfig.Companion.ZOOM_ACTIONS
import app.gamegrub.data.TouchGestureConfig.Companion.ZOOM_PAGE_UP_DOWN
import app.gamegrub.data.TouchGestureConfig.Companion.ZOOM_PLUS_MINUS
import app.gamegrub.data.TouchGestureConfig.Companion.ZOOM_SCROLL_WHEEL
