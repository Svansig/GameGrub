package app.gamegrub.ui.component.fabmenu.state
...
import app.gamegrub.ui.component.fabmenu.state.FloatingActionMenuState.Companion.Saver
...
fun rememberFloatingActionMenuState(
    ...
    return rememberSaveable(saver = Saver(confirmStateChange)) {
