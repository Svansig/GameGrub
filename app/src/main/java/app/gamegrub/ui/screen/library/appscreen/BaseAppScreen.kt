...
abstract class BaseAppScreen {
    ...
    companion object {
        private val installDialogStates = mutableStateMapOf<String, app.gamegrub.ui.component.dialog.state.MessageDialogState>()
        ...
        fun showInstallDialog(appId: String, state: app.gamegrub.ui.component.dialog.state.MessageDialogState) {
        ...
        fun getInstallDialogState(appId: String): app.gamegrub.ui.component.dialog.state.MessageDialogState? {
    ...
    fun Content(
        ...
        app.gamegrub.ui.screen.library.AppScreenContent(
