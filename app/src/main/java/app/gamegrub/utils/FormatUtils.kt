...
object GameSourceUtils {
    ...
    fun getIconResource(source: GameSource): Int {
        return when (source) {
            GameSource.STEAM -> app.gamegrub.R.drawable.ic_steam
            GameSource.GOG -> app.gamegrub.R.drawable.ic_gog
            GameSource.EPIC -> app.gamegrub.R.drawable.ic_epic
            GameSource.AMAZON -> app.gamegrub.R.drawable.ic_amazon
            GameSource.CUSTOM_GAME -> app.gamegrub.R.drawable.ic_custom
        }
    }
}
