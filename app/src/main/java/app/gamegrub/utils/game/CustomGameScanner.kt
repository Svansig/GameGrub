    ...
    private fun findNearbyImageIcon(folder: File, uniqueExeRel: String?): String? {
        ...
        if (extractedIcons.isNotEmpty()) {
            ...
            if (extractedIcons.size == 1) {
                Timber.tag("CustomGameScanner")
                    .d("findNearbyImageIcon - Using single extracted icon: ${extractedIcons.first().absolutePath}")
            ...
            if (!exeBase.isNullOrEmpty()) {
                ...
                if (matchingExtracted != null) {
                    Timber.tag("CustomGameScanner")
                        .d("findNearbyImageIcon - Using extracted icon matching exe: ${matchingExtracted.absolutePath}")
