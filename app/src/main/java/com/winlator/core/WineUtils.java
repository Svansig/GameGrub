...
public abstract class WineUtils {
    public static void createDosdevicesSymlinks(Container container) {
        ...
        if (!currentDrives.contains("D:") || !currentDrives.contains("E:")) {
            ...
            if (!currentDrives.contains("E:")) {
                missingDrives += "E:/data/data/app.gamegrub/storage";
            }
        ...
        for (String[] drive : container.drivesIterator()) {
            ...
            if (!linkTarget.isDirectory() && path.endsWith("/app.gamegrub/storage")) {
                linkTarget.mkdirs();
        ...
        if (gameDirectoryPath != null) {
            // Extract game name from path like "/data/data/app.gamegrub/Steam/steamapps/common/GameName"
    ...
    private static void setupSystemFonts(WineRegistryEditor registryEditor) {
        ...
        Timber.i("Setting up corefonts! %s", Arrays.deepToString(corefonts));
        ...
        Timber.i("Setting up winefonts! %s", Arrays.deepToString(wineFonts));
    }
}
