...
/**
 * Binding - Input control to X11/Wine input mapping.
 * 
 * Maps on-screen controls to:
 * - Mouse actions (buttons, scroll, movement)
 * - Keyboard keys (letters, numbers, F-keys)
 * - Gamepad buttons/joysticks
 * - System actions (menu, screenshot)
 */
public enum Binding {
