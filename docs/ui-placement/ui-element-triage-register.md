...
| UI-004 | P1 | Boundary | `app/src/main/java/app/gamegrub/ui/screen/library/LibraryScreen.kt` | OAuth + credential checks happened directly in composable and called handlers/services. | Moved OAuth result processing and platform auth status derivation into `LibraryViewModel` state/events. | `todo/UI-004.md` | In Progress |
