# ARCH-002b - Migrate GOGService to Base Class
...
GOGService has duplicated boilerplate that should be in base class.

## Scope

- In scope:
  - Refactor GOGService to extend GameStoreService
  - Move store-specific logic to GOGManager
...
- [ ] GOGService extends GameStoreService
- [ ] All GOG-specific logic in GOGManager
- [ ] Same functionality as before refactor
- [ ] GOG library sync works

## Validation

- [ ] Relevant unit/integration tests pass.
- [ ] `./gradlew lintKotlin` passes for touched files.
- [ ] Manual: Launch GOGService, sync library, verify games appear
