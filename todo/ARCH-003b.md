...
Steam-specific launch logic duplicated from other stores.

## Scope

- In scope:
  - Refactor SteamLaunchCommandBuilder to extend BaseLaunchCommandBuilder
  - Keep only Steam-specific command building
...
- [ ] SteamLaunchCommandBuilder extends base
- [ ] Launch works correctly for Steam games
...
- [ ] Manual: Launch Steam game, verify works
