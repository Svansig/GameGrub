...
GOG-specific launch logic duplicated from other stores.

## Scope

- In scope:
  - Refactor GogLaunchCommandBuilder to extend BaseLaunchCommandBuilder
  - Keep only GOG-specific command building
...
- [ ] GogLaunchCommandBuilder extends base
- [ ] Launch works correctly for GOG games
...
- [ ] Manual: Launch GOG game, verify works
