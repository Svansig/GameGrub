...
GOG download should implement unified interface.

## Scope

- In scope:
  - Refactor GOGDownloadManager to implement GameStoreDownloader
...
- [ ] GOGDownloadManager implements GameStoreDownloader
- [ ] Download works for GOG games

## Validation

- [ ] Tests pass
- [ ] `./gradlew lintKotlin` passes
- [ ] Manual: Download GOG game
